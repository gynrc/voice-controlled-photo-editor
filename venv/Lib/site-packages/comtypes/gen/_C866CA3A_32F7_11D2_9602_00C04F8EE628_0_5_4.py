...
__all__ = [
    'SVEPhoneme', 'SRSEIsSpeaking', 'ISpeechWaveFormatEx',
    'SpeechRegistryUserRoot', 'SAFT32kHz8BitStereo', 'SPRULESTATE',
    'SAFTADPCM_11kHzMono', 'DISPID_SAFType', 'SPVISEMES',
    'DISPID_SPAs_NewEnum', 'DISPID_SOTsCount',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SPIAudioStreamPosition',
    'SPEI_TTS_PRIVATE', 'DISPID_SPEDisplayText',
    'DISPID_SLGetGenerationChange', 'SPAUDIOSTATE',
    'DISPID_SpeechAudioStatus', 'DISPID_SRCVoicePurgeEvent',
    'SVESentenceBoundary', 'DISPID_SPAsItem', 'DISPID_SRGetFormat',
    'SP_VISEME_12', 'DISPID_SRRTStreamTime', 'SGRSTTEpsilon',
    'DISPID_SRCEAudioLevel', 'DISPID_SVGetAudioInputs',
    'ISpeechTextSelectionInformation', 'DISPID_SRSetPropertyString',
    'ISpeechPhraseElement', 'DISPID_SRAudioInput', 'DISPID_SPPsItem',
    'tagSPPROPERTYINFO', 'DISPID_SRCAudioInInterferenceStatus',
    'ISpeechRecognizerStatus', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SGRSTText', 'SVEWordBoundary', 'SPPS_RESERVED1',
    'SAFT11kHz16BitStereo', 'SPWT_DISPLAY', 'DISPID_SVEStreamStart',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRCEPropertyNumberChange',
    'SAFTCCITT_ALaw_44kHzMono', 'SDKLCurrentUser', 'SPAUDIOSTATUS',
    'DISPID_SOTCId', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SpeechPhraseProperty', 'DISPID_SOTCGetDataKey',
    'DISPID_SRGCmdLoadFromFile', 'SPEI_SR_BOOKMARK',
    'SpeechDiscardType', 'DISPID_SRCState', 'SAFT48kHz16BitMono',
    'DISPID_SMSADeviceId', 'DISPID_SLGetPronunciations',
    'SPRST_ACTIVE', 'SVSFIsXML', 'SLTUser', 'SpeechAudioVolume',
    'SDKLLocalMachine', 'DISPID_SRCEHypothesis',
    'DISPID_SRGDictationUnload', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SPIGetText', 'SPAUDIOOPTIONS', 'SREPropertyStringChange',
    'SPBO_NONE', 'ISpeechGrammarRules', 'DISPID_SPRNumberOfElements',
    'DISPID_SRIsShared', 'DISPID_SRCERequestUI',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT24kHz16BitStereo',
    'DISPID_SLWLangId', 'SAFTCCITT_ALaw_22kHzMono', 'SAFTDefault',
    'SVSFParseSapi', 'ISpeechPhraseProperty', 'DISPID_SPPName',
    'ISpeechLexiconPronunciations', 'DISPID_SPIAudioSizeTime',
    'DISPID_SpeechGrammarRule', 'STSF_LocalAppData',
    'SECFNoSpecialChars', 'ISpeechBaseStream', 'ISpRecognizer3',
    'DISPID_SGRClear', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRGCmdSetRuleState', 'ISpRecoResult',
    'SpeechRuleAttributes', 'SDTLexicalForm',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPSEMANTICFORMAT',
    'SPFILEMODE', 'SDA_Consume_Leading_Spaces', 'SPTEXTSELECTIONINFO',
    'ISpeechMMSysAudio', 'DISPID_SDKSetBinaryValue', 'ISpPhrase',
    'SPSNotOverriden', 'SpeechVoiceEvents',
    'DISPID_SRCEPropertyStringChange', 'SPPS_Unknown',
    'SAFT12kHz16BitMono', 'ISpNotifySource', 'DISPID_SOTRemove',
    'SDA_Two_Trailing_Spaces', 'SPRST_INACTIVE', 'eLEXTYPE_RESERVED7',
    'SPSInterjection', 'DISPID_SASCurrentSeekPosition',
    'SpeechCategoryRecognizers', 'DISPID_SAFGuid',
    'DISPID_SpeechPhraseAlternates', 'SREPhraseStart',
    'DISPID_SDKSetStringValue', 'SpInProcRecoContext',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRCERecognition',
    'SAFTCCITT_uLaw_22kHzMono', 'SpeechVisemeFeature',
    'SECNormalConfidence', 'DISPID_SRGId', 'SpeechFormatType',
    'SpStreamFormatConverter', 'SPEI_END_SR_STREAM', 'SITooSlow',
    'SPINTERFERENCE_NONE', 'DISPID_SVStatus', 'DISPID_SRGCommit',
    'SpLexicon', 'SPVPRI_NORMAL', 'DISPID_SDKGetStringValue',
    'DISPID_SVAudioOutput', 'DISPID_SRGRecoContext',
    'DISPID_SPPNumberOfElements', 'ISpeechRecoResultTimes',
    'DISPID_SpeechVoiceStatus', 'SPWORDLIST', 'DISPID_SPIProperties',
    'DISPID_SOTGetStorageFileName', 'SPCT_SUB_DICTATION',
    'SPWAVEFORMATTYPE', 'ISpStreamFormatConverter',
    'DISPID_SGRSTs_NewEnum', 'ISpeechLexiconWords', 'ISpObjectToken',
    'SAFT12kHz16BitStereo', 'SPWT_PRONUNCIATION', 'SRERequestUI',
    'SP_VISEME_20', 'ISpeechPhraseAlternate', 'DISPID_SMSSetData',
    'SAFT11kHz16BitMono', 'SPDKL_LocalMachine',
    'SpeechGrammarTagUnlimitedDictation', 'SAFT16kHz16BitStereo',
    'DISPID_SPEAudioSizeBytes', 'SAFT8kHz16BitMono', 'SPBO_AHEAD',
    'DISPID_SPIEngineId', 'SRTAutopause',
    'SpeechSpecialTransitionType', 'SpeechStreamSeekPositionType',
    'SGRSTTDictation', 'SREPropertyNumChange', 'eLEXTYPE_PRIVATE10',
    'ISpeechCustomStream', 'DISPID_SBSWrite',
    'DISPID_SRCRetainedAudio', 'SP_VISEME_8', 'SAFT12kHz8BitStereo',
    'DISPID_SRCCreateGrammar', 'DISPID_SGRsCommitAndSave',
    'SRCS_Disabled', 'SPSHT_NotOverriden', 'SPEI_REQUEST_UI',
    'ISpeechDataKey', 'SpeechVisemeType', 'SAFT22kHz16BitStereo',
    'ISpeechGrammarRuleStateTransitions', '_ISpeechRecoContextEvents',
    'DISPID_SPRDisplayAttributes', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SOTCategory', 'DISPID_SABufferNotifySize',
    'eLEXTYPE_RESERVED6', 'DISPID_SWFEFormatTag', 'SPPS_Verb',
    'Speech_StreamPos_Asap', 'SITooLoud', 'SPLEXICONTYPE', 'ISpVoice',
    'ISpeechRecoResultDispatch', 'DISPID_SRGetPropertyString',
    'SECLowConfidence', 'DISPID_SGRsAdd', 'DISPID_SRRSetTextFeedback',
    'DISPID_SPRuleName', 'DISPID_SAEventHandle', 'SAFT16kHz8BitMono',
    'DISPID_SRRSpeakAudio', 'SPEI_MIN_TTS', 'SPEI_RESERVED5',
    'SpCompressedLexicon', 'SP_VISEME_10', 'SPAS_RUN',
    'SPPS_RESERVED4', 'SPSHT_EMAIL', 'DISPID_SRCPause',
    'SPGS_DISABLED', 'SPEI_PHONEME', 'SpTextSelectionInformation',
    'SVSFDefault', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRCEStartStream', 'SPRST_INACTIVE_WITH_PURGE',
    'SpMemoryStream', 'DISPID_SRCRetainedAudioFormat',
    'SpNotifyTranslator', 'DISPIDSPTSI', 'SECFIgnoreKanaType',
    'DISPID_SRCEEndStream', 'DISPID_SDKCreateKey', 'DISPID_SGRSTRule',
    'DISPID_SAStatus', 'DISPID_SVWaitUntilDone',
    'DISPID_SPARecoResult', 'SGDSActive', 'SPEI_ADAPTATION',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechFileStream',
    'SDA_One_Trailing_Space', 'DISPID_SLPs_NewEnum',
    'ISpSerializeState', 'DISPID_SRCEInterference',
    'ISpPhoneticAlphabetSelection', 'DISPID_SRCSetAdaptationData',
    'SPLO_DYNAMIC', 'SpeechCategoryAppLexicons', 'ISpRecognizer2',
    'SGRSTTRule', 'SVP_12', 'DISPID_SVSLastStreamNumberQueued',
    'SpeechRecoEvents', 'DISPID_SpeechObjectToken',
    'DISPID_SpeechPhraseInfo', 'SPPARTOFSPEECH',
    'DISPID_SABIEventBias', 'DISPID_SVGetProfiles', 'SRCS_Enabled',
    'SPPS_Interjection', 'SpWaveFormatEx', 'eLEXTYPE_PRIVATE16',
    'ISpeechPhraseRules', 'SpeechRecoContextState', 'DISPID_SRRAudio',
    'eLEXTYPE_PRIVATE13', 'SPRST_ACTIVE_ALWAYS',
    'SAFTADPCM_8kHzStereo', 'SAFTCCITT_ALaw_11kHzStereo',
    'SAFT22kHz8BitMono', 'DISPID_SPIRetainedSizeBytes',
    'SSSPTRelativeToStart', 'DISPID_SPEAudioStreamOffset',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPRST_NUM_STATES',
    'DISPID_SpeechRecoResultTimes', 'SRAInterpreter', 'SPPS_Function',
    'SVEBookmark', 'SPAS_CLOSED', 'SP_VISEME_16', 'SPEI_RESERVED1',
    'SPSHORTCUTPAIR', 'DISPID_SMSGetData', 'DISPID_SOTGetAttribute',
    'STCInprocServer', 'DISPID_SRSetPropertyNumber',
    'DISPID_SPERequiredConfidence', 'SPPROPERTYINFO',
    'DISPID_SpeechAudio', 'SGRSTTTextBuffer', 'SPAUDIOBUFFERINFO',
    'SPCS_ENABLED', 'SDTReplacement', 'DISPID_SLPLangId',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SWFEChannels',
    'ISpeechLexicon', 'SPSVerb', 'SVP_10', 'SDKLCurrentConfig',
    'SAFT12kHz8BitMono', 'SPRULE',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRCEBookmark',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SPRuleParent',
    'DISPID_SRSCurrentStreamNumber', 'ISpProperties', 'SP_VISEME_0',
    'SPSEMANTICERRORINFO', 'SPSHORTCUTTYPE', 'SITooFast',
    'DISPID_SABufferInfo', 'ISpeechXMLRecoResult',
    'DISPID_SRDisplayUI', 'SPCT_SUB_COMMAND', 'DISPID_SABIBufferSize',
    'SPPHRASE', 'SPEI_RESERVED2', 'DISPID_SGRSAddSpecialTransition',
    'SRSInactive', 'SAFT8kHz8BitMono', 'SSFMOpenForRead',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPWT_LEXICAL',
    'ISpeechAudioFormat', 'DISPID_SGRAddState', 'DISPID_SOTs_NewEnum',
    'eLEXTYPE_LETTERTOSOUND', 'SGDSActiveWithAutoPause',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVSFIsNotXML',
    'SPEI_SENTENCE_BOUNDARY', 'SPEI_MAX_SR', 'DISPID_SBSFormat',
    'DISPID_SLWType', 'ISpeechPhraseElements', 'SREFalseRecognition',
    'eLEXTYPE_PRIVATE7', 'DISPID_SWFEExtraData', 'SLTApp',
    'SPWORDPRONUNCIATION', 'SPBO_PAUSE', 'SECFEmulateResult',
    'DISPID_SCSBaseStream', 'SRTSMLTimeout', 'ISpObjectWithToken',
    'SpeechAudioState', 'eLEXTYPE_MORPHOLOGY', 'SPEI_VISEME',
    'ISpPhraseAlt', 'SPSHORTCUTPAIRLIST', 'DISPID_SGRInitialState',
    'SVSFParseMask', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SpeechPhraseBuilder',
    'SSFMCreateForWrite', 'SPPS_NotOverriden',
    'SPDKL_DefaultLocation', 'SpeechVoiceSpeakFlags',
    'DISPID_SASFreeBufferSpace', 'DISPID_SVSInputWordLength',
    'SP_VISEME_6', 'DISPID_SRRAudioFormat', 'SpeechEngineProperties',
    '_SPAUDIOSTATE', 'SSSPTRelativeToEnd', 'DISPID_SDKDeleteValue',
    'SREStreamStart', 'SRAONone', 'DISPID_SGRName', 'SPRECOSTATE',
    'SWTAdded', 'IEnumString', 'ISpeechAudio', 'SVP_7',
    'SpeechStreamFileMode', 'ISpDataKey', 'DISPID_SVPause',
    'DISPID_SPPs_NewEnum', 'ISpGrammarBuilder', 'SREBookmark',
    'ISpeechResourceLoader', 'SpeechCategoryPhoneConverters',
    'DISPID_SPRulesItem', 'DISPID_SLPsCount', 'eLEXTYPE_RESERVED8',
    'DISPID_SRGSetTextSelection', 'SAFT44kHz16BitStereo',
    'DISPID_SFSOpen', 'SSFMCreate', 'SAFTGSM610_8kHzMono',
    'SAFTGSM610_22kHzMono', 'SWTDeleted', 'SASRun', 'SVP_3',
    'DISPIDSPTSI_SelectionOffset', 'eWORDTYPE_ADDED', 'ISpStream',
    'DISPIDSPRG', 'DISPID_SPEsItem', 'SVEAllEvents',
    'SAFT11kHz8BitMono', 'SPAR_Low', 'SAFTNonStandardFormat',
    'SRSActiveAlways', 'DISPID_SDKOpenKey', 'DISPID_SDKEnumKeys',
    'DISPID_SpeechMemoryStream', 'SGDisplay', 'SGDSInactive',
    'DISPID_SPEs_NewEnum', 'SPEI_TTS_BOOKMARK', 'SP_VISEME_5',
    'SRAORetainAudio', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_SR_PRIVATE', 'SDTDisplayText', 'DISPID_SVSkip',
    'SGSDisabled', 'DISPID_SRStatus', 'SPWORDPRONUNCIATIONLIST',
    'STCRemoteServer', 'DISPID_SWFESamplesPerSec', 'STCLocalServer',
    'SFTInput', 'DISPID_SLRemovePronunciation', 'SPEI_HYPOTHESIS',
    'ISpRecoCategory', 'SpeechMicTraining', 'Speech_Max_Word_Length',
    'DISPID_SPIElements', 'SAFT16kHz8BitStereo', 'SAFT24kHz16BitMono',
    'SVEEndInputStream', 'DISPID_SGRSTsCount', 'ISpeechRecoResult2',
    'DISPID_SVEBookmark', 'SVSFNLPSpeakPunc', 'SpResourceManager',
    'ISpNotifySink', 'SPCS_DISABLED', 'SREAllEvents', 'SBOPause',
    'DISPID_SRAudioInputStream', 'SLODynamic',
    'SPADAPTATIONRELEVANCE', 'SRTEmulated', 'DISPID_SVDisplayUI',
    'SAFT44kHz8BitMono', 'DISPID_SRRecognizer', 'DISPID_SGRs_NewEnum',
    'eLEXTYPE_RESERVED9', 'SpeechPropertyComplexResponseSpeed',
    'SBONone', 'DISPID_SLWsCount', 'SPINTERFERENCE_NOISE',
    'DISPID_SPEActualConfidence', 'DISPID_SVAudioOutputStream',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SAVolume',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SRGState',
    'DISPID_SRGIsPronounceable', 'SITooQuiet', 'SVEViseme',
    'SVEAudioLevel', 'ISpLexicon', 'SpeechDisplayAttributes',
    'tagSTATSTG', 'SPXMLRESULTOPTIONS', 'SPSUnknown',
    'DISPID_SVGetVoices', 'DISPID_SpeechPhraseProperties',
    'DISPID_SPIGetDisplayAttributes', 'SpNullPhoneConverter',
    'DISPID_SVEStreamEnd', 'IEnumSpObjectTokens', 'SP_VISEME_18',
    'SpMMAudioOut', 'SDTAudio', 'SRESoundEnd',
    'DISPID_SVSLastBookmark', 'DISPID_SOTsItem',
    'DISPID_SpeechLexiconWords', 'DISPID_SRRAlternates',
    'DISPID_SVSpeak', 'SRATopLevel', 'DISPID_SRGetPropertyNumber',
    'SPPS_Noncontent', 'SPEVENTENUM', 'SpeechAudioProperties',
    'SAFTCCITT_ALaw_11kHzMono', 'SRTReSent',
    'DISPID_SpeechPhraseRules', 'SAFTADPCM_22kHzStereo',
    'SPCONTEXTSTATE', 'SpeechWordPronounceable',
    'DISPID_SpeechPhoneConverter', 'DISPID_SGRSAddWordTransition',
    'SRADynamic', 'DISPID_SVRate', 'SPPS_RESERVED3',
    'DISPID_SMSAMMHandle', 'DISPID_SRGCmdLoadFromObject',
    'SPVOICESTATUS', 'SVP_9', 'UINT_PTR', 'SpeechRuleState',
    'SVEStartInputStream', 'ISpRecoContext', 'SpeechVoicePriority',
    'SVP_2', 'eLEXTYPE_PRIVATE15', 'SDKLDefaultLocation',
    'ISpeechObjectTokenCategory', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVSFIsFilename',
    'DISPID_SOTGetDescription', 'DISPID_SpeechRecoContext',
    'SAFT48kHz8BitMono', 'DISPID_SRCreateRecoContext',
    'SVSFVoiceMask', 'SWPKnownWordPronounceable',
    'SPSERIALIZEDRESULT', 'eLEXTYPE_PRIVATE14',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRGRules',
    'SFTSREngine', 'SPDATAKEYLOCATION', 'SASStop', 'SpeechTokenKeyUI',
    'SAFTCCITT_ALaw_44kHzStereo', 'SINoise', 'SREPrivate',
    'DISPID_SPEPronunciation', 'DISPID_SOTCreateInstance',
    'DISPID_SOTMatchesAttributes', 'DISPID_SGRId',
    'SpeechPartOfSpeech', 'DISPID_SDKGetBinaryValue',
    'DISPID_SPPChildren', 'ISpRecognizer', 'DISPID_SPCIdToPhone',
    'ISpXMLRecoResult', 'SPSNoun', 'SPLO_STATIC', 'STSF_AppData',
    'DISPID_SPILanguageId', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SPRuleChildren', 'SSFMOpenReadWrite',
    'DISPID_SPAStartElementInResult', 'DISPID_SPPsCount',
    'SVSFNLPMask', 'SWPUnknownWordUnpronounceable',
    'SpeechCategoryAudioOut', 'eLEXTYPE_PRIVATE3', 'STSF_FlagCreate',
    'eLEXTYPE_RESERVED4', 'SPPS_Noun', 'ISpeechAudioBufferInfo',
    'DISPID_SGRSTType', 'DISPID_SVESentenceBoundary', 'SPSHT_OTHER',
    'SP_VISEME_11', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRCESoundEnd', 'SAFT11kHz8BitStereo', 'eLEXTYPE_APP',
    'DISPID_SVAlertBoundary', 'SPSFunction',
    'DISPID_SpeechObjectTokens', 'SP_VISEME_3', 'eLEXTYPE_PRIVATE11',
    'DISPID_SpeechAudioFormat', 'SPSMF_SAPI_PROPERTIES',
    'ISpNotifyTranslator', 'SAFT16kHz16BitMono',
    'SAFTCCITT_uLaw_8kHzStereo', 'SGLexical',
    'DISPID_SASCurrentDevicePosition', 'SpAudioFormat',
    'SREAdaptation', 'SVSFPersistXML', 'DISPID_SpeechBaseStream',
    'SVF_None', 'SpeechCategoryAudioIn', 'SPFM_CREATE',
    'DISPID_SRCERecognizerStateChange', 'ISpeechRecoGrammar',
    'DISPID_SRSCurrentStreamPosition', 'eLEXTYPE_PRIVATE12',
    'DISPID_SpeechDataKey', 'DISPID_SPPValue', 'SAFT48kHz16BitStereo',
    'IInternetSecurityManager',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPINTERFERENCE_NOSIGNAL', 'ISpPhoneticAlphabetConverter',
    'SPBOOKMARKOPTIONS', 'SPEI_RESERVED3', 'SPSModifier',
    'SECFIgnoreWidth', 'SpeechGrammarRuleStateTransitionType',
    'SINoSignal', 'DISPID_SRCEFalseRecognition',
    'SpObjectTokenCategory', 'SVSFParseSsml', 'DISPID_SRRTLength',
    'DISPID_SLPPartOfSpeech', 'SPEI_MIN_SR',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVEPrivate',
    'SPEI_SOUND_END', 'SPEI_UNDEFINED', 'SpeechPropertyResponseSpeed',
    'SVP_14', 'DISPID_SGRSTPropertyName', 'SAFT48kHz8BitStereo',
    'DISPID_SWFEAvgBytesPerSec', 'DISPIDSPTSI_SelectionLength',
    'SREStateChange', 'SVP_11', 'SASPause', 'SAFT22kHz16BitMono',
    'SPEI_END_INPUT_STREAM', 'SVP_5', 'eLEXTYPE_PRIVATE2',
    'ISpeechPhraseRule', 'DISPID_SPRuleEngineConfidence',
    'SPCATEGORYTYPE', 'SpInprocRecognizer', 'DISPID_SDKSetLongValue',
    'SAFTADPCM_44kHzMono', 'DISPID_SVEVoiceChange',
    'eLEXTYPE_PRIVATE6', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SVEWord', 'SVSFlagsAsync', 'DISPID_SpeechPhraseAlternate',
    'SP_VISEME_19', 'ISpeechPhoneConverter',
    'SpeechCategoryRecoProfiles', 'SPSSuppressWord',
    'DISPID_SDKGetlongValue', 'SAFTADPCM_11kHzStereo', 'SP_VISEME_21',
    'SPXRO_SML', 'SPSMF_SRGS_SAPIPROPERTIES', 'STCInprocHandler',
    'SVF_Stressed', 'SRSActive', 'DISPID_SVSRunningState',
    'SPEI_MAX_TTS', 'DISPID_SPERetainedStreamOffset',
    'SSTTTextBuffer', 'ISpeechVoice', 'DISPID_SpeechRecognizer',
    'DISPID_SRRTimes', 'DISPID_SLPType', 'DISPID_SpeechCustomStream',
    'SP_VISEME_2', 'SVP_18', 'SPFM_NUM_MODES', 'ISpeechRecognizer',
    'DISPID_SRSAudioStatus', 'DISPID_SOTDataKey',
    'SAFTExtendedAudioFormat', 'eLEXTYPE_PRIVATE20',
    'SPPHRASEPROPERTY', 'SPBINARYGRAMMAR', 'DISPID_SpeechRecoResult2',
    'ISpeechPhraseProperties', 'DISPID_SpeechRecognizerStatus',
    'SPEI_RESERVED6', 'DISPID_SRCESoundStart', 'STSF_CommonAppData',
    'SPDKL_CurrentConfig', 'SPWORD', 'SGSExclusive',
    'DISPID_SLGetWords', 'DISPID_SpeechPhraseElement',
    'DISPID_SVSPhonemeId', 'ISpPhoneConverter', 'DISPID_SGRSTWeight',
    'SpMMAudioEnum', 'DISPID_SRRRecoContext', 'SPSHT_Unknown',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SASNonBlockingIO',
    'ISpRecoGrammar2', 'DISPID_SDKEnumValues', 'SPEVENTSOURCEINFO',
    'SPWF_SRENGINE', 'SRSEDone', 'SREHypothesis',
    'DISPID_SGRSTNextState', 'DISPID_SRGDictationSetState',
    'DISPID_SGRAttributes', 'ISpRecoContext2',
    'DISPID_SOTCEnumerateTokens', 'SPGS_ENABLED',
    'DISPID_SWFEBitsPerSample', 'SINone', 'DISPID_SpeechPhraseRule',
    'SGLexicalNoSpecialChars', 'SpStream', 'SPEI_PHRASE_START',
    'DISPID_SVEViseme', 'DISPID_SRProfile', 'SPSLMA',
    'SPEI_RECO_STATE_CHANGE', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'ISpEventSource', 'SpSharedRecognizer',
    'SpeechTokenIdUserLexicon', 'ISpEventSink', 'SP_VISEME_13',
    'DISPID_SOTCSetId', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRCRequestedUIType', 'SAFT22kHz8BitStereo',
    'DISPID_SpeechVoiceEvent', 'eWORDTYPE_DELETED',
    'SPEI_INTERFERENCE', 'SpeechRetainedAudioOptions', 'SPVPRI_OVER',
    'DISPID_SRRDiscardResultInfo', 'SpeechTokenShellFolder',
    'ISpObjectTokenCategory', 'SpUnCompressedLexicon',
    'SVSFUnusedFlags', 'SAFT8kHz16BitStereo',
    'DISPID_SLWPronunciations', 'SP_VISEME_1', 'SPWORDTYPE',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechRecoContext',
    'eLEXTYPE_PRIVATE5', 'DISPID_SRCRecognizer', 'DISPID_SRState',
    'ISpShortcut', 'SPGRAMMARSTATE', 'DISPID_SPIGrammarId',
    'DISPID_SPRFirstElement', 'SREInterference', 'SVPOver',
    'SPINTERFERENCE_TOOFAST', 'SpShortcut',
    'IInternetSecurityMgrSite', 'DISPID_SLAddPronunciation',
    'ISpResourceManager', 'SASClosed',
    'SpeechPropertyHighConfidenceThreshold', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRCEPhraseStart', 'SPRECOCONTEXTSTATUS',
    'SpeechAddRemoveWord', 'SVEVoiceChange', 'DISPID_SVSVisemeId',
    'SDTAlternates', 'ISpAudio', 'SpeechWordType',
    'SpeechAllElements', 'SPFM_OPEN_READONLY', 'SGRSTTWildcard',
    'ISpeechPhraseInfoBuilder', 'SAFTCCITT_uLaw_44kHzMono',
    'SP_VISEME_15', 'SPSTREAMFORMATTYPE', 'DISPID_SPRuleFirstElement',
    'SPEI_TTS_AUDIO_LEVEL', 'ISpeechPhraseReplacements',
    'eLEXTYPE_PRIVATE19', 'DISPID_SpeechPhraseReplacement', 'SpVoice',
    'DISPID_SRRGetXMLResult', 'SVP_21', 'DISPID_SPIStartTime',
    'SpFileStream', 'DISPID_SVEEnginePrivate',
    'SAFTCCITT_uLaw_22kHzStereo', 'SECHighConfidence', 'STCAll',
    'SVF_Emphasis', 'SPEI_START_SR_STREAM', 'DISPID_SGRSTransitions',
    'SPCT_SLEEP', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPEAudioTimeOffset', 'SPRECOGNIZERSTATUS',
    'SPRECORESULTTIMES', 'DISPID_SRRTTickCount', 'SVP_13',
    'SPWORDPRONOUNCEABLE', 'SpeechRecoProfileProperties',
    'SGRSTTWord', 'SAFTADPCM_44kHzStereo', 'DISPID_SGRSTPropertyId',
    'DISPID_SPPEngineConfidence', 'SVP_15', 'SGDSActiveUserDelimited',
    'DISPID_SPCPhoneToId', 'DISPID_SVSpeakStream', 'DISPID_SPPId',
    'DISPID_SABIMinNotification', 'SAFTCCITT_ALaw_8kHzMono',
    'SpeechEmulationCompareFlags', 'SAFT24kHz8BitMono',
    'DISPID_SPRuleId', 'DISPID_SGRSTsItem', 'DISPID_SBSSeek',
    'DISPID_SASState', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SAFGetWaveFormatEx', 'SPVPRIORITY',
    'DISPID_SRRGetXMLErrorInfo', 'SREStreamEnd', 'ISpeechObjectToken',
    'SDTAll', 'SVP_8', 'SpeechGrammarTagDictation',
    'ISpeechFileStream', 'SpCustomStream',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'ISpeechPhraseAlternates',
    'SpeechTokenValueCLSID', 'ISpeechGrammarRuleState',
    'SpeechDictationTopicSpelling', 'SPPHRASERULE',
    'DISPID_SRGetRecognizers', '__MIDL_IWinTypes_0009',
    'ISpeechGrammarRule', 'DISPID_SpeechGrammarRules',
    'DISPID_SREmulateRecognition', 'DISPID_SPISaveToMemory',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechRunState',
    'SDA_No_Trailing_Space', 'SAFTADPCM_8kHzMono',
    'ISequentialStream', 'DISPID_SVResume', 'DISPID_SPIReplacements',
    'DISPID_SPIEnginePrivateData', 'SPINTERFERENCE_TOOQUIET',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPAR_Unknown',
    'DISPID_SVIsUISupported', 'SPXRO_Alternates_SML', 'SDTRule',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPRsItem', 'DISPID_SPACommit',
    'SSTTWildcard', 'SpeechTokenKeyAttributes', 'DISPID_SRCBookmark',
    'DISPID_SVSInputSentenceLength', 'SLOStatic', 'IStream',
    'DISPID_SLGenerationId', 'SPCT_COMMAND', 'SRADefaultToActive',
    'SVP_0', 'DISPID_SPRs_NewEnum', 'Speech_StreamPos_RealTime',
    'SPPS_RESERVED2', 'SVSFParseAutodetect',
    'DISPID_SVEventInterests', 'DISPID_SBSRead',
    'DISPID_SPPBRestorePhraseFromMemory', 'SVPAlert',
    'SpeechAudioFormatType', 'SWPUnknownWordPronounceable',
    'DISPID_SASetState', 'SpeechGrammarState',
    'DISPID_SADefaultFormat', 'DISPID_SGRAddResource',
    'DISPID_SPAPhraseInfo', 'SPWF_INPUT',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRIsUISupported',
    'SAFT44kHz8BitStereo', 'SP_VISEME_9', 'SPVPRI_ALERT',
    'DISPID_SVVolume', 'SRESoundStart', 'SPAS_STOP',
    'DISPID_SpeechPhraseReplacements', 'SECFDefault',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPCLangId',
    'DISPID_SRSClsidEngine', 'SpPhraseInfoBuilder',
    'DISPID_SpeechRecoResult', 'Speech_Default_Weight',
    'DISPID_SGRsDynamic', 'ISpMMSysAudio',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SRCResume',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRCVoice',
    'DISPID_SPRules_NewEnum', 'SPEVENT',
    'DISPID_SPRuleNumberOfElements', 'SAFTText',
    'eLEXTYPE_VENDORLEXICON', 'SPSMF_UPS', 'Speech_Max_Pron_Length',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFT32kHz16BitMono', 'eLEXTYPE_USER',
    'SRSInactiveWithPurge', 'SpeechInterference', 'DISPID_SLWWord',
    'SPEI_START_INPUT_STREAM', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPPConfidence', 'DISPID_SRGCmdLoadFromResource',
    'SPFM_CREATE_ALWAYS', 'eLEXTYPE_PRIVATE18', 'LONG_PTR',
    'ISpeechPhraseInfo', 'SPPS_Modifier',
    'DISPID_SpeechPhraseElements', 'DISPID_SpeechLexicon',
    'ISpeechAudioStatus', 'SpeechGrammarTagWildcard',
    'DISPID_SpeechMMSysAudio', 'SAFT8kHz8BitStereo',
    '_RemotableHandle', 'SpeechDataKeyLocation',
    'DISPID_SpeechObjectTokenCategory', 'ISpRecoGrammar',
    'SP_VISEME_14', 'SP_VISEME_7', 'SPAR_Medium', 'SVP_4',
    'SAFT32kHz8BitMono', 'SAFTGSM610_44kHzMono', 'DISPID_SPPParent',
    'SPBO_TIME_UNITS', 'SPEI_SOUND_START', 'DISPID_SVEAudioLevel',
    'ISpeechRecoResult', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpeechTokenKeyFiles', 'DISPID_SLPPhoneIds',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRCCmdMaxAlternates',
    'SAFT32kHz16BitStereo', 'SPDKL_CurrentUser', 'DISPID_SGRSRule',
    'DISPID_SVVoice', 'SpeechLexiconType',
    'DISPID_SRSNumberOfActiveRules', 'SRTExtendableParse',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SPRsCount', 'SPAO_NONE',
    'SDTPronunciation', 'DISPID_SPRuleConfidence',
    'SpeechPropertyResourceUsage', 'SSTTDictation',
    'DISPID_SVSLastBookmarkId', 'SpeechRegistryLocalMachineRoot',
    'SPAS_PAUSE', 'DISPID_SRRPhraseInfo', 'SAFT24kHz8BitStereo',
    'SRTStandard', 'SpeechAudioFormatGUIDText', 'ISpeechLexiconWord',
    'SVP_1', 'DISPID_SGRsCommit', 'SPEI_VOICE_CHANGE',
    'eLEXTYPE_PRIVATE1', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SRCEEnginePrivate', 'DISPID_SOTRemoveStorageFileName',
    'ISpeechLexiconPronunciation', 'eLEXTYPE_PRIVATE9',
    'SPSERIALIZEDPHRASE', 'SRAImport', 'SpeechEngineConfidence',
    'DISPID_SpeechLexiconProns', 'SVPNormal', 'SAFTADPCM_22kHzMono',
    'SpeechUserTraining', 'SAFTGSM610_11kHzMono',
    'DISPID_SVSpeakCompleteEvent', 'SP_VISEME_17',
    'DISPID_SPRulesCount', 'DISPID_SRRSaveToMemory',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SpeechVoice',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SOTCDefault',
    'DISPID_SRGDictationLoad', 'DISPID_SRGCmdLoadFromMemory',
    'SVP_20', 'DISPID_SGRsItem', 'SVP_16', 'SpeechCategoryVoices',
    'SPFM_OPEN_READWRITE', 'DISPIDSPTSI_ActiveOffset',
    'SPCT_DICTATION', 'SRAExport', 'SPPS_LMA', 'SDTProperty',
    'SPRS_INACTIVE', 'SPAR_High', 'SAFTNoAssignedFormat',
    'eLEXTYPE_RESERVED10', 'SpPhoneticAlphabetConverter',
    'WAVEFORMATEX', 'SPINTERFERENCE_TOOSLOW', 'SVP_17',
    'eLEXTYPE_PRIVATE17', 'DISPID_SWFEBlockAlign',
    'DISPID_SVSLastResult', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SVSInputWordPosition', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SVEPhoneme', 'DISPID_SLWsItem', 'SpSharedRecoContext',
    'SPEI_RECOGNITION', 'DISPID_SDKDeleteKey',
    'SpeechRecognizerState', 'SpPhoneConverter',
    '_ISpeechVoiceEvents', 'SpObjectToken', 'DISPID_SRCEAdaptation',
    'ISpeechObjectTokens', 'SPLOADOPTIONS',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SRSSupportedLanguages',
    'DISPID_SPELexicalForm', 'ISpeechMemoryStream', 'ISpStreamFormat',
    'ISpeechVoiceStatus', 'SVP_19', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpMMAudioIn', 'SAFT44kHz16BitMono', 'DISPID_SPEsCount',
    'DISPID_SLPsItem', 'SPPS_SuppressWord', 'DISPID_SFSClose',
    'SPINTERFERENCE', 'DISPID_SPEEngineConfidence',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPGRAMMARWORDTYPE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SpeechLoadOption',
    'SRARoot', 'SpeechGrammarWordType', 'DISPID_SRGReset',
    'eLEXTYPE_PRIVATE8', 'DISPID_SLPSymbolic',
    'eLEXTYPE_USER_SHORTCUT', 'SRERecoOtherContext', 'SVP_6',
    'SpeechTokenContext', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SOTDisplayUI', 'DISPID_SRCEventInterests',
    'DISPID_SpeechLexiconWord', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPIRule', 'DISPID_SPEAudioSizeTime',
    'DISPID_SLWs_NewEnum', 'SGSEnabled', 'DISPID_SMSALineId',
    'DISPID_SOTId', 'SPGS_EXCLUSIVE', 'DISPID_SGRsCount',
    'DISPID_SPRText', 'SPRS_ACTIVE_USER_DELIMITED',
    'ISpeechPhraseReplacement', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SpeechBookmarkOptions', 'ISpeechGrammarRuleStateTransition',
    'SREAudioLevel', 'SPRS_ACTIVE', 'DISPID_SpeechWaveFormatEx',
    'SPAO_RETAIN_AUDIO', 'DISPID_SOTSetId', 'SPPHRASEREPLACEMENT',
    'DISPID_SGRsFindRule', 'eLEXTYPE_PRIVATE4',
    'DISPID_SGRSTPropertyValue', 'SGPronounciation',
    'DISPID_SPPFirstElement', 'SPPHRASEELEMENT', 'SECFIgnoreCase',
    'DISPID_SOTIsUISupported', 'DISPID_SVPriority',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SPAsCount',
    'SpeechRecognitionType', 'SRERecognition', 'SP_VISEME_4'
]
